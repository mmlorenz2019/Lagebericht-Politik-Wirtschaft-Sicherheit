...
class FrontendContractTests(unittest.TestCase):
    ...
    def test_period_model_and_context_are_loaded_and_rendered_safely(self):
        ...
        self.assertLess(html.index("assets/period-model.js?v=9"), html.index("assets/app.js?v=9"))
        ...
        self.assertIn("./assets/period-model.js?v=9", worker)
    ...
    def test_app_refreshes_index_when_pwa_becomes_visible(self):
        ...
        self.assertLess(html.index("assets/freshness-model.js?v=9"), html.index("assets/app.js?v=9"))
        ...
        self.assertIn("lagebericht-shell-v9", worker)
        self.assertIn("./assets/freshness-model.js?v=9", worker)
    ...
    def test_service_worker_does_not_cache_cross_origin_requests(self):
        ...
        self.assertIn('assets/rating-model.js?v=9', html)
